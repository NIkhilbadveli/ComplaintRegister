...
public class SportsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ListView listView = (ListView) findViewById(R.id.comp_sports_list);
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
                ...
                Intent i = new Intent(SportsActivity.this, ComplaintEditing.class);
                i.putExtra("subject", rowItems.get(pos).getSubject());
                i.putExtra("Position", position);
                i.putExtra("Activity", "Sports Complaints");
                startActivity(i);
                return true;
            }
        });
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1,
                ...
                Intent i = new Intent(SportsActivity.this, ComplaintDescription.class);
                i.putExtra("subject", rowItems.get(pos).getSubject());
                i.putExtra("Position", position);
                i.putExtra("Activity", "Sports Complaints");
                startActivity(i);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(SportsActivity.this, SportsEditingActivity.class);
