...
public class AcademicsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ListView listView = (ListView) findViewById(R.id.comp_academics_list);
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> arg0, View arg1,
                ...
                Intent i = new Intent(AcademicsActivity.this,ComplaintEditing.class);
                i.putExtra("subject",rowItems.get(pos).getSubject());
                i.putExtra("Position",position);
                i.putExtra("Activity","Academics Complaints");
                startActivity(i);
                return true;
            }
        });
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1,
                ...
                Intent i = new Intent(AcademicsActivity.this, ComplaintDescription.class);
                i.putExtra("subject", rowItems.get(pos).getSubject());
                i.putExtra("Position", position);
                i.putExtra("Activity", "Academics Complaints");
                startActivity(i);
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(AcademicsActivity.this, AcademicsEditingActivity.class);
